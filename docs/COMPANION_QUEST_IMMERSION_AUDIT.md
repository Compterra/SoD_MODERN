...
| --- | --- | --- | --- | --- | --- |
| Ymira - Mercy Under Arms | `$g_sod_ymira_refugee_focus_center`; `$g_sod_ymira_refugee_witnessed` | Quest journal says to go to captive/refugee witness; companion report names quest-framework aftermath | Travel to focus village, speak with elder/town refugee/captive troop | Ymira comments that mercy has witnesses before branch choice | Direct companion dialogue after witness |
