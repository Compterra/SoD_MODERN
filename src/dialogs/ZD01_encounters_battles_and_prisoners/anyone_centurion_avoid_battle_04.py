...
[anyone, "centurion_avoid_battle", [
	...
	(else_try),
		...
		(str_store_string, s0, "@I concur, {playername}, but my orders are very explicit and come from the Legate himself. I cannot withdraw."),
	(else_try),
		(troop_slot_eq, "$g_talk_troop", slot_troop_centurion_personality, slcp_imperialist),
		(str_store_string, s0, "@I must give you credit for your care towards your people, but unfortunately I cannot let you evade me any further. My orders have been given, my objective is clear: to destroy or capture you. Make your choice."),
	(else_try),
