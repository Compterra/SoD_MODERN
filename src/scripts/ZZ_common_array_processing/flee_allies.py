...
("flee_allies",
                      [
                        ...
                        (try_for_agents, ":agent"),
                          ...
                          (eq, reg0, 0),
						  #SoD begin troop level should matter more! Peasants should run while Knights still stand
                          ...
                          (store_div, ":pay_panic", "$g_sod_battle_ally_pay_strain", 12),
                          (store_div, ":fatigue_panic", "$g_sod_battle_ally_fatigue", 15),
