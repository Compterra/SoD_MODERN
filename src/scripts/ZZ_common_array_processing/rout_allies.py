...
("rout_allies",
                      [
                        ...
                        (try_for_agents, ":agent"),
                          ...
                          (val_div, ":wounded_panic", 8),
                          (val_add, ":chance_ply", ":wounded_panic"),
                          (try_begin),
                            (lt, ":troop_level", 10),
                            (val_add, ":chance_ply", 12),
                          (else_try),
                            (ge, ":troop_level", 25),
                            (val_sub, ":chance_ply", 10),
                          (try_end),
                          (store_div, ":troop_level_resistance", ":troop_level", 4),
                          ...
                          (try_begin),
                            ...
                            (val_sub, ":chance_ply", 12),
                          (else_try),
                            (val_add, ":chance_ply", 15),
                          (try_end),
                          (store_sub, ":morale_gap", 50, "$g_sod_battle_ally_lord_morale"),
                          (val_max, ":morale_gap", 0),
                          (val_add, ":chance_ply", ":morale_gap"),
                          (store_div, ":pay_panic", "$g_sod_battle_ally_pay_strain", 8),
                          (store_div, ":fatigue_panic", "$g_sod_battle_ally_fatigue", 10),
                          (val_add, ":chance_ply", ":pay_panic"),
                          (val_add, ":chance_ply", ":fatigue_panic"),
                          #SOD (val_sub, ":chance_ply", ":troop_level"),
                          (store_random_in_range, ":routed", 1, 101),
                          (try_begin),
                            (le, ":routed", ":chance_ply"),
                            #(display_message, "@One ally runs!", debug_color),
                            (agent_get_position, pos2, ":agent"),
                            (position_move_z, pos2, 200, 0),
                            (agent_clear_scripted_mode, ":agent"),
                            # M&B 1.011 headers do not expose Warband's agent_start_running_away.
