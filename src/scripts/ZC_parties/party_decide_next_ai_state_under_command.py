...
("party_decide_next_ai_state_under_command",
    [
      ...
      (try_begin),
        ...
        (try_begin),
          (this_or_next|eq, ":commander_ai_state", spai_besieging_center),
          (this_or_next|eq, ":commander_ai_state", spai_holding_center),
          (this_or_next|eq, ":commander_ai_state", spai_patrolling_around_center),
          (this_or_next|eq, ":commander_ai_state", spai_recruiting_troops),
          (this_or_next|eq, ":commander_ai_state", spai_raiding_around_center),
          (eq, ":commander_ai_state", spai_retreating_to_center),
          (neg|is_between, ":commander_ai_object", centers_begin, centers_end),
          (assign, ":commander_ai_state", spai_undefined),
          (assign, ":commander_ai_object", -1),
        (try_end),
