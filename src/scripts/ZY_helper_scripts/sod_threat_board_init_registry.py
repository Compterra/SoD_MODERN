...
("sod_threat_board_init_registry",
 [
   ...
   (try_for_parties, ":threat_party"),
     ...
     (party_slot_eq, ":threat_party", slot_party_sod_threat_active_quest, "qst_regional_threat_contract"),
     (party_set_slot, ":threat_party", slot_party_sod_threat_active_quest, 0),
   (try_end),
