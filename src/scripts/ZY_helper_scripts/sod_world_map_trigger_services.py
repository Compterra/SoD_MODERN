...
("sod_world_map_process_ai_mercenary_boss_followers",
 [
       (try_for_parties, ":cur_party"),
        ...
        # Patrol, garrison, and supply contracts are independent economic assignments.
        (party_get_slot, ":contract_role", ":cur_party", slot_party_sod_merc_contract_role),
        (this_or_next|eq, ":contract_role", sod_merc_contract_role_none),
        (this_or_next|eq, ":contract_role", sod_merc_contract_role_field_company),
        (this_or_next|eq, ":contract_role", sod_merc_contract_role_escort),
        (eq, ":contract_role", sod_merc_contract_role_special_world_activity),
