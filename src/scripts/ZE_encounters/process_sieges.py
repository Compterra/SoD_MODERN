...
("process_sieges",
    [
      (try_for_range, ":center_no", walled_centers_begin, walled_centers_end),
            ...
            (try_begin),
              ...
              (try_begin),
                ...
                (try_begin),
                  ...
                  (store_mul, ":population_delta", ":starvation_loss", -1),
                  (call_script, "script_sod_center_apply_population_delta", ":center_no", ":population_delta"),
              ...
              (else_try),
                ...
                (try_begin),
                  ...
                  (store_mul, ":population_delta", ":critical_loss", -1),
                  (call_script, "script_sod_center_apply_population_delta", ":center_no", ":population_delta"),
                (try_end),
              ...
              (else_try),
                ...
                (try_begin),
                  ...
                  (store_mul, ":population_delta", ":low_loss", -1),
                  (call_script, "script_sod_center_apply_population_delta", ":center_no", ":population_delta"),
                (try_end),
              (try_end),
            (try_end),
        ...
        (party_get_slot, ":old_food_store", ":center_no", slot_party_food_store),
        (store_sub, ":food_delta", ":town_food_store", ":old_food_store"),
