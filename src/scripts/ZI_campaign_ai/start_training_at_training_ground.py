...
("start_training_at_training_ground",
    [
      ...
      (try_begin),
        ...
        (str_store_string, s68, "@Your opponents are ready for the fight."),
      (else_try),
        (eq, "$g_mt_mode", ctm_mounted),
        (try_begin),
          (eq, ":mission_weapon_type", itp_type_bow),
        ...
        (try_end),
        (str_store_string, s68, "@Try to destroy as many targets as you can. You have two and a half minutes to clear the track."),
      (else_try),
        ...
        (str_store_string, s68, "@Stay behind the line on the ground and shoot the targets. Try not to waste any shots."),
      (try_end),
