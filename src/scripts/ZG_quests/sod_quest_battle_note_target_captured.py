"""Battle progression hook for captured targets."""

from typing import Any

SCRIPTS = [
    ("sod_quest_battle_note_target_captured", []),
]
...
def script_sod_quest_battle_note_target_captured(*args: Any, **kwargs: Any) -> None:
