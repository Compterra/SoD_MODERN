"""Battle progression hook for defeated agents."""

from typing import Any

SCRIPTS = [
    ("sod_quest_battle_agent_defeated", []),
]
...
def script_sod_quest_battle_agent_defeated(*args: Any, **kwargs: Any) -> None:
...
__all__ = [
    "script_sod_quest_battle_agent_defeated",
]
