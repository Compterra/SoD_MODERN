...
("draw_banner_to_region",
        [
          ...
          (try_begin),
            (neg|is_between, ":bg_type", custom_banner_backgrounds_begin, custom_banner_backgrounds_end),
            (assign, ":bg_type", custom_banner_backgrounds_begin),
          (try_end),
          (try_begin),
            (eq, ":bg_color_1", 0xFFFFFFFF),
            (eq, ":bg_color_2", 0xFFFFFFFF),
            (assign, ":bg_color_1", 0xFF1E4F9A),
            (assign, ":bg_color_2", 0xFFE4C46A),
          (try_end),
