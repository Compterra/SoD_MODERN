...
("update_villages_infested_by_bandits",
      [(try_for_range, ":village_no", villages_begin, villages_end),
          ...
          (else_try),
            ...
            (store_sub, ":bandit_infestation_chance", 300, ":bandit_reduction"),
            (val_clamp, ":bandit_infestation_chance", 25, 301),
            (store_mul, ":random_scaled", ":random_no", 100),
            (lt, ":random_scaled", ":bandit_infestation_chance"),
