...
def main():
    ...
    assert_contains(recon_notes, "script_sod_center_public_health_brief_to_s0", "recon notes public health brief")
    assert_contains(recon_notes, "Public health: {s57}", "recon notes public health text")
