...
def main() -> int:
    ...
    assert_contains(goods, "script_sod_center_apply_food_delta")
    ...
    assert_contains(goods, "store_item_value")
    assert_contains(goods, "script_sod_change_center_wealth")
    assert_contains(goods, "consumption_value")
    assert_contains(goods, "shortage_cost")
