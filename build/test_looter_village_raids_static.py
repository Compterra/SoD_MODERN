...
def test_player_interruption_and_elder_feedback_exist() -> None:
    ...
    assert_contains(raids, "slot_town_food_store")
    assert_contains(raids, "val_sub, \":prosperity\", 4")
    assert_contains(raids, "val_sub, \":local_prosperity\", 3")
