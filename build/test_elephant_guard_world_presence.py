...
def main() -> int:
    ...
    assert_contains(presence, "party_set_faction, \":new_party\", \"fac_sod_merc_guild3\"")
    ...
    assert_contains(report, "sanctuary patrols active")
    assert_contains(report, "relic processions active")
    assert_contains(report, "Devotion {reg21}, supplies {reg22}, omens {reg23}")
