...
("round_shield_1", 0, "sample_shield_round_1", 512, 256, 0, 0, 0, 0,
   [
       ...
       (set_fixed_point_multiplier, 100),
	   (try_begin),
		(eq, ":banner_mesh", "trp_player"),
         (troop_get_slot, ":bg_color_1", ":banner_mesh", slot_troop_custom_banner_bg_color_1),
         (cur_tableau_set_background_color, ":bg_color_1"),
		(call_script, "script_draw_banner_to_region", ":banner_mesh", -50, 0, 10000, 10000, 8000, 8000, 10000, 8000, 1),
	   (else_try),
		(init_position, pos1),
   ...
   [
       ...
       (try_begin),
		(eq, ":banner_mesh", "trp_player"),
         (troop_get_slot, ":bg_color_1", ":banner_mesh", slot_troop_custom_banner_bg_color_1),
         (cur_tableau_set_background_color, ":bg_color_1"),
		 (call_script, "script_draw_banner_to_region", ":banner_mesh", -57, 30, 10000, 10000, 8000, 8000, 10000, 8000, 1),
	   (else_try),
		(init_position, pos1),
   ...
   [
       ...
       (try_begin),
		(eq, ":banner_mesh", "trp_player"),
         (troop_get_slot, ":bg_color_1", ":banner_mesh", slot_troop_custom_banner_bg_color_1),
         (cur_tableau_set_background_color, ":bg_color_1"),
		 (call_script, "script_draw_banner_to_region", ":banner_mesh", -50, 30, 10000, 10000, 8000, 8000, 10000, 8000, 1),
	   (else_try),
		(init_position, pos1),
		(position_set_x, pos1, -50),
   ...
   [
       ...
       (try_begin),
		(eq, ":banner_mesh", "trp_player"),
         (troop_get_slot, ":bg_color_1", ":banner_mesh", slot_troop_custom_banner_bg_color_1),
         (cur_tableau_set_background_color, ":bg_color_1"),
		 (call_script, "script_draw_banner_to_region", ":banner_mesh", -55, 30, 10000, 10000, 8000, 8000, 10000, 8000, 1),
	   (else_try),
		(init_position, pos1),
		(position_set_x, pos1, -60),
   ...
   [
       ...
       (try_begin),
		(eq, ":banner_mesh", "trp_player"),
         (troop_get_slot, ":bg_color_1", ":banner_mesh", slot_troop_custom_banner_bg_color_1),
         (cur_tableau_set_background_color, ":bg_color_1"),
		 (call_script, "script_draw_banner_to_region", ":banner_mesh", -50, 40, 10000, 10000, 8000, 8000, 10000, 8000, 1),
	   (else_try),
		(init_position, pos1),
		(position_set_x, pos1, -50),
   ...
   [
       ...
       (try_begin),
		(eq, ":banner_mesh", "trp_player"),
         (troop_get_slot, ":bg_color_1", ":banner_mesh", slot_troop_custom_banner_bg_color_1),
         (cur_tableau_set_background_color, ":bg_color_1"),
		 (call_script, "script_draw_banner_to_region", ":banner_mesh", -50, 0, 10000, 10000, 9800, 9800, 10000, 8000, 1),
	   (else_try),
		(init_position, pos1),
  ...
  ("heraldic_armor_a", 0, "sample_heraldic_armor_a", 512, 512, 0, 0, 0, 0,
   [
       ...
       (try_begin),
         ...
         (troop_get_slot, ":bg_color_1", ":banner_mesh", slot_troop_custom_banner_bg_color_1),
         (cur_tableau_set_background_color, ":bg_color_1"),
         (call_script, "script_draw_banner_to_region", ":banner_mesh", -25, 40, 10000, 10000, 6000, 6000, 10000, 8000, 1),
       (else_try),
  ...
  ("heraldic_armor_b", 0, "sample_heraldic_armor_b", 512, 512, 0, 0, 0, 0,
   [
       ...
       (try_begin),
         ...
         (troop_get_slot, ":bg_color_1", ":banner_mesh", slot_troop_custom_banner_bg_color_1),
         (cur_tableau_set_background_color, ":bg_color_1"),
         (call_script, "script_draw_banner_to_region", ":banner_mesh", -25, 25, 10000, 10000, 9800, 9800, 10000, 8000, 1),
       (else_try),
  ...
  ("heraldic_armor_d", 0, "sample_heraldic_armor_d", 512, 512, 0, 0, 0, 0,
   [
       ...
       (try_begin),
         ...
         (troop_get_slot, ":bg_color_1", ":banner_mesh", slot_troop_custom_banner_bg_color_1),
         (cur_tableau_set_background_color, ":bg_color_1"),
         (cur_tableau_add_mesh_with_vertex_color, "mesh_heraldic_armor_bg", pos1, 200, 100, ":bg_color_1"),
         (call_script, "script_draw_banner_to_region", ":banner_mesh",  0, 50, 10000, 10000, 6000, 6000, 10000, 8000, 1),
       (else_try),
         (store_sub, ":background_slot", ":banner_mesh", arms_meshes_begin), #banner_meshes_begin),
         (troop_get_slot, ":background_color", "trp_banner_background_color_array", ":background_slot"),
         (cur_tableau_set_background_color, ":background_color"),
...
##     (try_end),
 ...
 #SOD Siofna's Nobility Shield Material Tableaus
#
("vilshield1", 0, "sample_shield_matte", 512, 512, 0, 0, 0, 0,
   [
       (store_script_param, ":banner_mesh", 1),
       ...
       (init_position, pos1),
       (position_set_z, pos1, 10),
       (cur_tableau_add_mesh, "mesh_tableau_mesh_shield_vilshield1", pos1, 0, 0),
       (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
       ]),
#
	("horse_health_bar", 0, "missiles", 32, 32, 0, 0, 0, 0,
   [
     (set_fixed_point_multiplier, 100),
     (init_position, pos1),
     (cur_tableau_add_mesh, "mesh_color_picker", pos1, 0, 0),
     ...
     (position_move_x, pos1, -2),
     (position_move_y, pos1, -2),
     (cur_tableau_add_mesh_with_vertex_color, "mesh_white_plane", pos1, 200, 0, red),
     (cur_tableau_set_camera_parameters, 0, 20, 20, 0, 100000),
     ]),
	 
	#heraldic armors
	("plate_armor", 0, "sample_costumes5_banner", 1024, 1024, 0, 0, 0, 0,
   [
       (store_script_param_1, ":banner_mesh"),
       ...
       (try_begin),
         ...
         (troop_get_slot, ":bg_color_1", ":banner_mesh", slot_troop_custom_banner_bg_color_1),
         (cur_tableau_set_background_color, ":bg_color_1"),
         (call_script, "script_draw_banner_to_region", ":banner_mesh", -60, 75, 10000, 10000, 2000, 2000, 4000, 10000, 1),
       (else_try),
         (store_sub, ":background_slot", ":banner_mesh", arms_meshes_begin), #banner_meshes_begin),
         (troop_get_slot, ":background_color", "trp_banner_background_color_array", ":background_slot"),
         (cur_tableau_set_background_color, ":background_color"),
       ...
       (init_position, pos1),
       (position_set_z, pos1, 100),
       (cur_tableau_add_mesh, "mesh_tableau_mesh_costumes5_banner", pos1, 0, 0),
       (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
       ]),
	("black_armor", 0, "sample_costumes5_banner", 1024, 1024, 0, 0, 0, 0,
   [
       (store_script_param_1, ":banner_mesh"),
       ...
       (try_begin),
         ...
         (troop_get_slot, ":bg_color_1", ":banner_mesh", slot_troop_custom_banner_bg_color_1),
         (cur_tableau_set_background_color, ":bg_color_1"),
         (call_script, "script_draw_banner_to_region", ":banner_mesh", 60, -57, 10000, 10000, 2000, 2000, 4000, 10000, 1),
       (else_try),
         (store_sub, ":background_slot", ":banner_mesh", arms_meshes_begin), #banner_meshes_begin),
         (troop_get_slot, ":background_color", "trp_banner_background_color_array", ":background_slot"),
         (cur_tableau_set_background_color, ":background_color"),
	...
	("cuir_bouilli", 0, "sample_costumes6_banner", 1024, 1024, 0, 0, 0, 0,
   [
       (store_script_param_1, ":banner_mesh"),
       ...
       (try_begin),
         ...
         (troop_get_slot, ":bg_color_1", ":banner_mesh", slot_troop_custom_banner_bg_color_1),
         (cur_tableau_set_background_color, ":bg_color_1"),
         (call_script, "script_draw_banner_to_region", ":banner_mesh", -8, -44, 10000, 10000, 2200, 2200, 5000, 10000, 1),
       (else_try),
         (store_sub, ":background_slot", ":banner_mesh", arms_meshes_begin), #banner_meshes_begin),
         (troop_get_slot, ":background_color", "trp_banner_background_color_array", ":background_slot"),
         (cur_tableau_set_background_color, ":background_color"),
         ...
         (position_set_y, pos1, -2),
         (cur_tableau_add_mesh, ":banner_mesh", pos1, 40, 0),
       (try_end),
       (init_position, pos1),
       (position_set_z, pos1, 100),
       (cur_tableau_add_mesh, "mesh_tableau_mesh_costumes6_banner", pos1, 0, 0),
       (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
       ]),
	("haubergeon", 0, "sample_costumes6_banner", 1024, 1024, 0, 0, 0, 0,
   [
       (store_script_param_1, ":banner_mesh"),
       ...
       (try_begin),
         ...
         (troop_get_slot, ":bg_color_1", ":banner_mesh", slot_troop_custom_banner_bg_color_1),
         (cur_tableau_set_background_color, ":bg_color_1"),
         (call_script, "script_draw_banner_to_region", ":banner_mesh", -72, 80, 10000, 10000, 2200, 2200, 5000, 10000, 1),
       (else_try),
         (store_sub, ":background_slot", ":banner_mesh", arms_meshes_begin), #banner_meshes_begin),
         (troop_get_slot, ":background_color", "trp_banner_background_color_array", ":background_slot"),
         (cur_tableau_set_background_color, ":background_color"),
	...
	("banded_armor", 0, "sample_costumes6_banner", 1024, 1024, 0, 0, 0, 0,
   [
       (store_script_param_1, ":banner_mesh"),
       ...
       (try_begin),
         ...
         (cur_tableau_set_background_color, ":bg_color_1"),
         (init_position, pos1),
         (call_script, "script_draw_banner_to_region", ":banner_mesh", 65, -50, 10000, 10000, 2500, 2500, 5000, 10000, 1),
       (else_try),
         (store_sub, ":background_slot", ":banner_mesh", arms_meshes_begin), #banner_meshes_begin),
         (troop_get_slot, ":background_color", "trp_banner_background_color_array", ":background_slot"),
         (cur_tableau_set_background_color, ":background_color"),
	...
	("studded_leather_coat", 0, "sample_costumes4_banner", 1024, 1024, 0, 0, 0, 0,
   [
       (store_script_param_1, ":banner_mesh"),
       ...
       (try_begin),
         ...
         (troop_get_slot, ":bg_color_1", ":banner_mesh", slot_troop_custom_banner_bg_color_1),
         (cur_tableau_set_background_color, ":bg_color_1"),
         (call_script, "script_draw_banner_to_region", ":banner_mesh", -57, -48, 10000, 10000, 3000, 3000, 5000, 10000, 1),
       (else_try),
         (store_sub, ":background_slot", ":banner_mesh", arms_meshes_begin), #banner_meshes_begin),
         (troop_get_slot, ":background_color", "trp_banner_background_color_array", ":background_slot"),
         (cur_tableau_set_background_color, ":background_color"),
       ...
       (init_position, pos1),
       (position_set_z, pos1, 100),
       (cur_tableau_add_mesh, "mesh_tableau_mesh_costumes4_banner", pos1, 0, 0),
       (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
       ]),
	("mail_shirt", 0, "sample_costumes4_banner", 1024, 1024, 0, 0, 0, 0,
   [
       (store_script_param_1, ":banner_mesh"),
       ...
       (try_begin),
         ...
         (troop_get_slot, ":bg_color_1", ":banner_mesh", slot_troop_custom_banner_bg_color_1),
         (cur_tableau_set_background_color, ":bg_color_1"),
         (call_script, "script_draw_banner_to_region", ":banner_mesh", 62, 75, 10000, 10000, 3000, 3000, 5000, 10000, 1),
       (else_try),
         (store_sub, ":background_slot", ":banner_mesh", arms_meshes_begin), #banner_meshes_begin),
         (troop_get_slot, ":background_color", "trp_banner_background_color_array", ":background_slot"),
         (cur_tableau_set_background_color, ":background_color"),
   ...
   [
       ...
       (try_begin),
         ...
         (troop_get_slot, ":bg_color_1", ":banner_mesh", slot_troop_custom_banner_bg_color_1),
         (cur_tableau_set_background_color, ":bg_color_1"),
         (call_script, "script_draw_banner_to_region", ":banner_mesh", 56, 75, 10000, 10000, 2500, 2500, 4500, 10000, 1),
       (else_try),
         (store_sub, ":background_slot", ":banner_mesh", arms_meshes_begin), #banner_meshes_begin),
         (troop_get_slot, ":background_color", "trp_banner_background_color_array", ":background_slot"),
         (cur_tableau_set_background_color, ":background_color"),
	...
	("mail_hauberk", 0, "sample_costumes12_banner", 1024, 1024, 0, 0, 0, 0,
   [
       (store_script_param_1, ":banner_mesh"),
       ...
       (try_begin),
         ...
         (troop_get_slot, ":bg_color_1", ":banner_mesh", slot_troop_custom_banner_bg_color_1),
         (cur_tableau_set_background_color, ":bg_color_1"),
         (call_script, "script_draw_banner_to_region", ":banner_mesh", 49, 70, 10000, 10000, 3000, 3000, 6000, 10000, 1),
       (else_try),
         (store_sub, ":background_slot", ":banner_mesh", arms_meshes_begin), #banner_meshes_begin),
         (troop_get_slot, ":background_color", "trp_banner_background_color_array", ":background_slot"),
         (cur_tableau_set_background_color, ":background_color"),
         ...
         (init_position, pos1),
         (position_set_z, pos1, 50),
         (position_set_x, pos1, 47),
         (position_set_y, pos1, 120),
         (cur_tableau_add_mesh, ":banner_mesh", pos1, 50, 0),
       (try_end),
       (init_position, pos1),
       (position_set_z, pos1, 100),
       (cur_tableau_add_mesh, "mesh_tableau_mesh_costumes12_banner", pos1, 0, 0),
       (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
       ]),
