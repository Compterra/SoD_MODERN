...
scenes = [
  ("random_scene",sf_generate|sf_randomize|sf_auto_entry_points,"none", "none", (0,0),(320,320),-0.5,"0x300028000003e8fa0000034e00004b34000059be",
    [],[]),
  ("conversation_scene",0,"encounter_spot", "bo_encounter_spot", (-40,-40),(40,40),-100,"0",
    [],[]),
  ("random_scene_steppe",sf_generate|sf_randomize|sf_auto_entry_points,"none", "none", (0,0),(320,320),-0.5,"0x0000000229602800000691a400003efe00004b34000059be",
    [],[], "outer_terrain_steppe"),
  ("random_scene_plain",sf_generate|sf_randomize|sf_auto_entry_points,"none", "none", (0,0),(320,320),-0.5,"0x0000000229602800000691a400003efe00004b34000059be",
    [],[], "outer_terrain_plain"),
  ("random_scene_snow",sf_generate|sf_randomize|sf_auto_entry_points,"none", "none", (0,0),(320,320),-0.5,"0x0000000229602800000691a400003efe00004b34000059be",
    [],[], "outer_terrain_snow"),
  ("random_scene_desert",sf_generate|sf_randomize|sf_auto_entry_points,"none", "none", (0,0),(320,320),-0.5,"0x0000000229602800000691a400003efe00004b34000059be",
    [],[], "outer_terrain_steppe"),
  ("random_scene_steppe_forest",sf_generate|sf_randomize|sf_auto_entry_points,"none", "none", (0,0),(320,320),-0.5,"0x300028000003e8fa0000034e00004b34000059be",
    [],[], "outer_terrain_plain"),
  ("random_scene_plain_forest",sf_generate|sf_randomize|sf_auto_entry_points,"none", "none", (0,0),(320,320),-0.5,"0x300028000003e8fa0000034e00004b34000059be",
    [],[], "outer_terrain_plain"),
  ("random_scene_snow_forest",sf_generate|sf_randomize|sf_auto_entry_points,"none", "none", (0,0),(320,320),-0.5,"0x300028000003e8fa0000034e00004b34000059be",
    [],[], "outer_terrain_snow"),
  ("random_scene_desert_forest",sf_generate|sf_randomize|sf_auto_entry_points,"none", "none", (0,0),(320,320),-0.5,"0x300028000003e8fa0000034e00004b34000059be",
    [],[], "outer_terrain_steppe"),
  ...
  ("tutorial_5",sf_generate,"none", "none", (0,0),(120,120),-100,"0x3a06dca80005715c0000537400001377000011fe",
    [],[], "outer_terrain_plain"),
#SoD Skirmish begin
#1 desert small map flat as stool
("sod_skirmish1",sf_generate,"none", "none", (0,0),(120,120),-100,"0x0000000450000500000390e4000072600000288e000029c1", 
    [],[], "outer_terrain_steppe"),
#2 plain medium map, small hills
("sod_skirmish2",sf_generate,"none", "none", (0,0),(120,120),-100,"0x3a078bb2000589630000667200002fb90000179c", 
    [],[], "outer_terrain_plain"),
#3 siege defense with belfry
("sod_skirmish3",sf_generate,"none", "none", (0,0),(120,120),-100,"0x00001d63c005114300006228000053bf00004eb9", 
    [],[], "outer_terrain_plain"),
#4 siege attack with belfry
("sod_skirmish4",sf_generate,"none", "none", (0,0),(100,100),-100,"0x314d060900036cd70000295300002ec9000025f3",
    [],[],"outer_terrain_plain"),
# hill skirmish
("sod_skirmish5",sf_generate,"none", "none", (0,0),(120,120),-100,"0x0000000020000500000374dd000069d000002658000030d9", 
    [],[], "outer_terrain_plain"),

("sod_skirmish_town",sf_generate,"none", "none", (0,0),(120,120),-100,"0x00000000300005000005254b00000ad5000067a000003cb0", 
    [],[], "outer_terrain_plain"),
("sod_skirmish_ruins",sf_generate,"none", "none", (0,0),(120,120),-100,"0x0000000031a80d460003514b00005c9100000000000066e2", 
    [],[], "outer_terrain_plain"),
("sod_skirmish_ambush",sf_generate,"none", "none", (0,0),(120,120),-100,"0x000000003660080700048a1c000027df0000190800000002", 
    [],[], "outer_terrain_plain"),
("sod_skirmish_cementary",sf_generate,"none", "none", (0,0),(120,120),-100,"0x0000000046a785320005695f0000622d000057ea0000276e", 
    [],[], "outer_terrain_snow"),
	
#SoD Skirmish end

#SoD fgtq (fight guild troops quest)
  #Black Army
  ("fgtq_ba_s1",sf_generate,"none", "none", (0,0),(100,100),-100,"0x00000002300658bc0007bded000025520000093800006114",
    [],[], "outer_terrain_plain"),
  ("fgtq_ba_s2",sf_indoors, "castle_h_interior_a", "bo_castle_h_interior_a", (-100,-100),(100,100),-100,"0",
    [],[]),
  ("fgtq_ba_s3",sf_generate,"none", "none", (0,0),(100,100),-100,"0x00000002300658bc0007bded000025520000093800006114",
    [],[], "outer_terrain_plain"),
  #Conquistadors
  ("fgtq_c_s1",sf_generate,"none", "none", (0,0),(100,100),-100,"0x000000023004561e00069da700000f490000256b000058b5",
    [],[],"outer_terrain_plain"),
  ("fgtq_c_s2",sf_generate,"none", "none", (0,0),(100,100),-100,"0x000000023004561e00069da700000f490000256b000058b5",
    [],[],"outer_terrain_plain"),
  ("fgtq_c_s3",sf_generate,"none", "none", (0,0),(100,100),-100,"0x000000023004561e00069da700000f490000256b000058b5",
    [],[],"outer_terrain_plain"),
  #Elephant Guard
  ("fgtq_eg_s1",sf_generate,"none", "none", (0,0),(100,100),-100,"0x0000000220045d9b0005d9760000034a00002a3e00006fbd",
    [],[],"outer_terrain_steppe"),
  ("fgtq_eg_s2",sf_generate,"none", "none", (0,0),(100,100),-100,"0x0000000220045d9b0005d9760000034a00002a3e00006fbd",
    [],[],"outer_terrain_steppe"),
  ("fgtq_eg_s3",sf_indoors, "sod_eg_interior", "bo_sod_eg_interior", (-100,-100),(100,100),-100,"0",
    [],[]),
  ("fgtq_eg_s4",sf_generate,"none", "none", (0,0),(100,100),-100,"0x0000000220045d9b0005d9760000034a00002a3e00006fbd",
    [],[],"outer_terrain_steppe"),
  #Jotnar Clan
  ("fgtq_jc_s1",sf_generate,"none", "none", (0,0),(100,100),-100,"0x0000000130069b270004dd390000689b00002d3b00001876",
    [],[],"outer_terrain_plain"),
  ("fgtq_jc_s2",sf_generate,"none", "none", (0,0),(100,100),-100,"0x0000000130069b270004dd390000689b00002d3b00001876",
    [],[],"outer_terrain_plain"),
  ("fgtq_jc_s3",sf_indoors, "sod_jc_interior", "bo_sod_jc_interior", (-100,-100),(100,100),-100,"0",
    [],[]),
  #Serpent Host
  ("fgtq_sh_s1",sf_generate,"none", "none", (0,0),(100,100),-100,"0x00000001300410320005a96800006b5300004edc00000d11",
    [],[],"outer_terrain_plain"),
  ("fgtq_sh_s2",sf_generate,"none", "none", (0,0),(100,100),-100,"0x00000001300410320005a96800006b5300004edc00000d11",
    [],[],"outer_terrain_plain"),
  ("fgtq_sh_s3",sf_indoors, "sod_sh_interior", "bo_sod_sh_interior", (-100,-100),(100,100),-100,"0",
    [],[]),
  ("fgtq_sh_s4",sf_generate,"none", "none", (0,0),(100,100),-100,"0x00000001300410320005a96800006b5300004edc00000d11",
    [],[],"outer_terrain_plain"),
  #Slavers
  ("fgtq_praven",sf_indoors,"interior_prison_f", "bo_interior_prison_f", (-100,-100),(100,100),-100,"0",
    [],[]),
  ("fgtq_reyvadin",sf_indoors,"dungeon_a", "bo_dungeon_a", (-100,-100),(100,100),-100,"0",
    [],[]),
  ("fgtq_tulga",sf_indoors,"interior_prison_d", "bo_interior_prison_d", (-100,-100),(100,100),-100,"0",#### B bkullanilmayacak
    [],[]),
  ("fgtq_sargoth",sf_indoors,"interior_prison_b", "bo_interior_prison_b", (-100,-100),(100,100),-100,"0",
    [],[]),
  ("fgtq_jelkala",sf_indoors,"dungeon_torture_room_a", "bo_dungeon_torture_room_a", (-100,-100),(100,100),-100,"0",
    [],[]),
  #Boar Clan
  ("fgtq_bc_s1",sf_generate,"none", "none", (0,0),(100,100),-100,"0x000000013003e02d0005ed7800002c2e0000688800005fe4",
    [],[],"outer_terrain_plain"),
  ("fgtq_bc_s2",sf_generate,"none", "none", (0,0),(100,100),-100,"0x000000013003e02d0005ed7800002c2e0000688800005fe4",
    [],[],"outer_terrain_plain"),

#SoD merc bases (interiors)
("sod_merc_guild_1_interior",sf_indoors, "castle_h_interior_a", "bo_castle_h_interior_a", (-100,-100),(100,100),-100,"0",
    [],[]),
("sod_merc_guild_2_interior",sf_indoors, "interior_castle_k", "bo_interior_castle_k", (-100,-100),(100,100),-100,"0",
    [],[]),
("sod_merc_guild_3_interior",sf_indoors, "sod_eg_interior", "bo_sod_eg_interior", (-100,-100),(100,100),-100,"0",
    [],[]),
("sod_merc_guild_4_interior",sf_indoors, "sod_jc_interior", "bo_sod_jc_interior", (-100,-100),(100,100),-100,"0",
    [],[]),
("sod_merc_guild_5_interior",sf_indoors, "sod_sh_interior", "bo_sod_sh_interior", (-100,-100),(100,100),-100,"0",
    [],[]),

#SoD merc bases
  ("sod_merc_guild_1",sf_generate,"none", "none", (0,0),(100,100),-100,"0x00000002300658bc0007bded000025520000093800006114",
    [],[], "outer_terrain_plain"), #Black Army
  ("sod_merc_guild_2",sf_generate,"none", "none", (0,0),(100,100),-100,"0xa009c7070002589600002b6300001ef60000122e",
    [],["bonus_chest_3"],"outer_terrain_town_thir_1"), #Conquistadors
  ("sod_merc_guild_3",sf_generate,"none", "none", (0,0),(100,100),-100,"0x0000000220045d9b0005d9760000034a00002a3e00006fbd",
    [],[],"outer_terrain_steppe"), #Elephant Guard
  ("sod_merc_guild_4",sf_generate,"none", "none", (0,0),(100,100),-100,"0x0000000130069b270004dd390000689b00002d3b00001876",
    [],[],"outer_terrain_plain"), #Jotnar Clan
  ("sod_merc_guild_5",sf_generate,"none", "none", (0,0),(100,100),-100,"0x00000001300410320005a96800006b5300004edc00000d11",
    [],[],"outer_terrain_plain"), #Serpent Host
  ("elephant_guard_training_scene",sf_generate,"none", "none", (0,0),(100,100),-100,"0x0000000220045d9b0005d9760000034a00002a3e00006fbd",
    [],[],"outer_terrain_steppe"),
  ("slavers_base",sf_indoors,"interior_prison_a", "bo_interior_prison_a", (-100,-100),(100,100),-100,"0",
    [],[]),
  ("slavers_base_praven",sf_indoors,"interior_prison_f", "bo_interior_prison_f", (-100,-100),(100,100),-100,"0",
    [],[]),
  ("slavers_base_reyvadin",sf_indoors,"dungeon_a", "bo_dungeon_a", (-100,-100),(100,100),-100,"0",
    [],[]),
  ("slavers_base_tulga",sf_indoors,"interior_prison_d", "bo_interior_prison_d", (-100,-100),(100,100),-100,"0",#### B bkullanilmayacak
    [],[]),
  ("slavers_base_sargoth",sf_indoors,"interior_prison_b", "bo_interior_prison_b", (-100,-100),(100,100),-100,"0",
    [],[]),
  ("slavers_base_jelkala",sf_indoors,"dungeon_torture_room_a", "bo_dungeon_torture_room_a", (-100,-100),(100,100),-100,"0",
    [],[]),
  ("prison_break",sf_indoors,"dungeon_torture_room_a", "bo_dungeon_torture_room_a", (-100,-100),(100,100),-100,"0",
    [],[]),
  ("jotnar_clan_arena",sf_generate,"none", "none", (0,0),(100,100),-100,"0xa0001d9300031ccb0000156f000048ba0000361c",
    [],[],"outer_terrain_plain"),
#Boar clan:
  ("boar_clan_base",sf_generate,"none", "none", (0,0),(100,100),-100,"0x000000013003e02d0005ed7800002c2e0000688800005fe4",
    [],[],"outer_terrain_plain"),
