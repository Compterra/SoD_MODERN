...
def save_game_menus(variable_list,variable_uses,tag_uses,quick_strings):
  ...
  for game_menu in game_menus:
    ofile.write("menu_%s %d %s %s"%(game_menu[0],game_menu[1],str.replace(game_menu[2]," ","_"),game_menu[3]))
