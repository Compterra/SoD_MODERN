...
# [ src/triggers/ST02_every_hour/entry_0029.py:L1-L167 ] 3
(3,
   [
      (store_current_hours, ":cur_hours"),
      (try_for_range, ":center_no", walled_centers_begin, walled_centers_end),
...
# [ src/triggers/ST04_weekly/entry_0038.py:L1-L256 ] 24 * 7
(24 * 7,
    [
	(try_for_range, ":center_no", centers_begin, centers_end),
...
# [ src/triggers/ST01_every_frame/entry_0043.py:L1-L117 ] 0.1
(0.1,
   [
    (try_for_range, ":troop_no", heroes_begin, heroes_end),
        (troop_slot_eq, ":troop_no", slot_troop_occupation, slto_kingdom_hero),
...
# [ src/triggers/ST02_every_hour/entry_0049.py:L1-L195 ] 8
(8,
   [
...
# [ src/triggers/ST02_every_hour/entry_0050.py:L1-L271 ] 8
(8,
   [
       (try_for_parties, ":party_no"),
...
# [ src/triggers/ST03_daily/entry_0051.py:L1-L80 ] 24
(24,
   [
       (try_for_range, ":center_no", castles_begin, castles_end),
...
# [ src/triggers/ST03_daily/entry_0054.py:L1-L81 ] 24
(24,
   [
...
# [ src/triggers/ST01_every_frame/entry_0057.py:L1-L6 ] 0
(0,
   [(map_free),
    (call_script, "script_sod_refresh_player_map_icon"),
    ]),
...
# [ src/triggers/ST03_daily/entry_0088.py:L1-L125 ] 24
(24,
  [
    (store_current_day, ":cur_day"),
...
# [ src/triggers/ST04_weekly/entry_0101.py:L1-L282 ] 24 * 7
(24 * 7,
  [
    (try_begin),
      (eq, "$g_sod_hide_messages", -2),
...
# [ src/triggers/ST04_weekly/entry_0102.py:L1-L270 ] 24 * 7
(24 * 7,
  [
    (try_begin),
      (eq, "$g_sod_hide_messages", -2),
...
# [ src/triggers/ST04_weekly/entry_0104.py:L1-L547 ] 24 * 7
(24 * 7,
  [
    (try_begin),
      (eq, "$g_sod_hide_messages", -2),
...
# [ src/triggers/ST04_weekly/entry_0105.py:L1-L884 ] 24 * 7
(24 * 7,
  [
    (try_begin),
      (eq, "$g_sod_hide_messages", -2),
...
# [ src/triggers/ST02_every_hour/entry_0124.py:L1-L68 ] 1
(1,
   [
       (try_for_parties, ":cur_party"),
        (party_slot_eq, ":cur_party", slot_party_type, spt_ai_mercenaries),
...
# [ src/triggers/ST01_every_frame/entry_0130.py:L1-L31 ] 0.1
(0.1,
   [
     (try_for_parties, ":cur_party"),
		(this_or_next|party_slot_eq, ":cur_party", slot_party_type, spt_player_mercenaries),
...
# [ src/triggers/ST02_every_hour/entry_0142.py:L1-L376 ] 1
...
# [ src/triggers/ST01_every_frame/entry_0175_sod_battle_commander_reset.py:L1-L9 ] 0
(0,
   [
      (map_free),
