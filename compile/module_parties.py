...
#Kuba - a little python function allowing to copy 
#       parties from txt file instead of generating a new file
# 1 - copy from txt file
# 0 - generate a new file
copy_parties_from_txt_file = 0
#Kuba end
...
# Tuavus   Pamir   vezona 
  ...
  ("training_ground_1", "Training Field",  pf_disabled|icon_training_ground|pf_hide_defenders|pf_is_static|pf_always_visible|pf_label_medium, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(37.4, 102.8),[], 100),
  ("training_ground_2", "Training Field",  pf_disabled|icon_training_ground|pf_hide_defenders|pf_is_static|pf_always_visible|pf_label_medium, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-12.8, 33),[], 100),
  ("training_ground_3", "Training Field",  pf_disabled|icon_training_ground|pf_hide_defenders|pf_is_static|pf_always_visible|pf_label_medium, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(70.5, 72.0),[], 100),
  ("training_ground_4", "Training Field",  pf_disabled|icon_training_ground|pf_hide_defenders|pf_is_static|pf_always_visible|pf_label_medium, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(11.5, -75.2),[], 100),
  ("training_ground_5", "Training Field",  pf_disabled|icon_training_ground|pf_hide_defenders|pf_is_static|pf_always_visible|pf_label_medium, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-125.8, 12.5),[], 100),
...
#  bridge_a
  ...
  ("looter_spawn_point"   ,"{!}looter_sp",pf_disabled|pf_is_static, no_menu, pt_none, fac_outlaws,0,ai_bhvr_hold,0,(26, 77),[]),
  ("steppe_bandit_spawn_point"  ,"the steppes",pf_disabled|pf_is_static, no_menu, pt_none, fac_outlaws,0,ai_bhvr_hold,0,(125, 9),[]),
  ("taiga_bandit_spawn_point"   ,"the tundra",pf_disabled|pf_is_static, no_menu, pt_none, fac_outlaws,0,ai_bhvr_hold,0,(78, 84),[]),
  ("black_khergit_spawn_point"  ,"{!}black_khergit_sp",pf_disabled|pf_is_static, no_menu, pt_none, fac_black_khergits,0,ai_bhvr_hold,0,(155.349, -101.135),[]),
  ("forest_bandit_spawn_point"  ,"the forests",pf_disabled|pf_is_static, no_menu, pt_none, fac_outlaws,0,ai_bhvr_hold,0,(-35, 18),[]),
  ("mountain_bandit_spawn_point","the highlands",pf_disabled|pf_is_static, no_menu, pt_none, fac_outlaws,0,ai_bhvr_hold,0,(-90, -26.8),[]),
  ("sea_raider_spawn_point_1"   ,"the coast",pf_disabled|pf_is_static, no_menu, pt_none, fac_outlaws,0,ai_bhvr_hold,0,(48.5, 110),[]),
  ("sea_raider_spawn_point_2"   ,"the coast",pf_disabled|pf_is_static, no_menu, pt_none, fac_outlaws,0,ai_bhvr_hold,0,(-42, 76.7),[]),
  
  
  ("sod_merc_rb","ransom_broker",pf_disabled, no_menu, pt_none, fac_commoners,0,ai_bhvr_hold,0,(0,0),[]),
 
  ("sod_merc_1","Guild1",pf_disabled, no_menu, pt_none, fac_sod_merc_guild1,0,ai_bhvr_hold,0,(0,0),[]),
  ("sod_merc_2","Guild2",pf_disabled, no_menu, pt_none, fac_sod_merc_guild2,0,ai_bhvr_hold,0,(0,0),[]),
  ("sod_merc_3","Guild3",pf_disabled, no_menu, pt_none, fac_sod_merc_guild3,0,ai_bhvr_hold,0,(0,0),[]),
  ("sod_merc_4","Guild4",pf_disabled, no_menu, pt_none, fac_sod_merc_guild4,0,ai_bhvr_hold,0,(0,0),[]),
  ("sod_merc_5","Guild5",pf_disabled, no_menu, pt_none, fac_sod_merc_guild5,0,ai_bhvr_hold,0,(0,0),[]),
  ("sod_merc_6","Guild6",pf_disabled, no_menu, pt_none, fac_sod_merc_guild6,0,ai_bhvr_hold,0,(0,0),[]),
  ("sod_merc_7","Guild7",pf_disabled, no_menu, pt_none, fac_sod_merc_guild7,0,ai_bhvr_hold,0,(0,0),[]),
  
  ("sod_merc_1_elite","Guild1",pf_disabled, no_menu, pt_none, fac_sod_merc_guild1,0,ai_bhvr_hold,0,(0,0),[]),
  ("sod_merc_2_elite","Guild2",pf_disabled, no_menu, pt_none, fac_sod_merc_guild2,0,ai_bhvr_hold,0,(0,0),[]),
  ("sod_merc_3_elite","Guild3",pf_disabled, no_menu, pt_none, fac_sod_merc_guild3,0,ai_bhvr_hold,0,(0,0),[]),
  ("sod_merc_4_elite","Guild4",pf_disabled, no_menu, pt_none, fac_sod_merc_guild4,0,ai_bhvr_hold,0,(0,0),[]),
  ("sod_merc_5_elite","Guild5",pf_disabled, no_menu, pt_none, fac_sod_merc_guild5,0,ai_bhvr_hold,0,(0,0),[]),
  ("sod_merc_6_elite","Guild6",pf_disabled, no_menu, pt_none, fac_sod_merc_guild6,0,ai_bhvr_hold,0,(0,0),[]),
  ("sod_merc_7_elite","Guild7",pf_disabled, no_menu, pt_none, fac_sod_merc_guild7,0,ai_bhvr_hold,0,(0,0),[]),


  ("sod_merc_guild_1", "The Black Army",     icon_castle_b|pf_castle|pf_hide_defenders,  no_menu, pt_none, fac_sod_merc_guild1,0,ai_bhvr_hold,0,(-83, 25), [],15),
  ("sod_merc_guild_2", "The Conquistadors",  icon_castle_c|pf_castle|pf_hide_defenders,  no_menu, pt_none, fac_sod_merc_guild2,0,ai_bhvr_hold,0,(56, 117), [],0),
  ("sod_merc_guild_3", "The Elephant Guard", icon_village_a|pf_castle|pf_hide_defenders, no_menu, pt_none, fac_sod_merc_guild3,0,ai_bhvr_hold,0,(130, -20),[],160),
  ("sod_merc_guild_4", "The Jotnar Clan",    icon_castle_c|pf_castle|pf_hide_defenders,  no_menu, pt_none, fac_sod_merc_guild4,0,ai_bhvr_hold,0,(-8, 68),  [],0),
  ("sod_merc_guild_5", "The Serpent Host",   icon_castle_b|pf_castle|pf_hide_defenders,  no_menu, pt_none, fac_sod_merc_guild5,0,ai_bhvr_hold,0,(-74, -56),[],60),
  ("sod_merc_guild_6", "Slavers dummy base", pf_disabled,                                no_menu, pt_none, fac_sod_merc_guild6,0,ai_bhvr_hold,0,(0, 0),    [],0),
  ("sod_merc_guild_7", "The Boar Clan",      icon_village_a|pf_castle|pf_hide_defenders, no_menu, pt_none, fac_sod_merc_guild7,0,ai_bhvr_hold,0,(87, -95), []),
