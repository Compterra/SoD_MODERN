...
QUESTS = [
# Prison Break chain quest
	("slave_q1", "Deliver message to {s13}", 0,
	 "Diego, a village elder imprisoned by the Slavers, asked you to take a message to his old friend {s13}.",
	),
	("slave_q2", "Return to Diego", 0,
	 "{s9} refused to help Diego directly.",
	),
	("slave_q3", "Prison Break", 0,
	 "Fight your way out of the dungeon.",
	),

# Mercenary guild masters quests
#Boar Clan
