...
store_faction_of_party          = 2204 # (store_faction_of_party,<destination>,<party>),
...
str_store_troop_name            = 2322  # (call_script, "script_store_troop_name",<string_register>,<troop_id>),
...
str_store_troop_name_link       = 2341 # (call_script, "script_store_troop_name_link",<string_register>,<troop_id>),
...
lhs_operations = [try_for_range,
                  ...
                  # MORDACHAI - these should have been here
                  store_and,
                  store_or,
                  ]
