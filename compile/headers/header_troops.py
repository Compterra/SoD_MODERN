...
def sod_upgrade(troops, base_troop, upgraded_troop):
	sod_upgrade_command_list.append((troop_set_slot, base_troop, slot_troop_sod_upgrade1, upgraded_troop))
	sod_upgrade_command_list.append((troop_set_slot, upgraded_troop, slot_troop_sod_soldier, get_upgrade_at(troops[upgraded_troop][3])))

def sod_upgrade2(troops, base_troop, upgraded_troop1, upgraded_troop2):
	sod_upgrade_command_list.append((troop_set_slot, base_troop, slot_troop_sod_upgrade1, upgraded_troop1))
	sod_upgrade_command_list.append((troop_set_slot, upgraded_troop1, slot_troop_sod_soldier, get_upgrade_at(troops[upgraded_troop1][3])))
	sod_upgrade_command_list.append((troop_set_slot, base_troop, slot_troop_sod_upgrade2, upgraded_troop2))
	sod_upgrade_command_list.append((troop_set_slot, upgraded_troop2, slot_troop_sod_soldier, get_upgrade_at(troops[upgraded_troop2][3])))
	sod_upgrade_command_list.append((troop_set_slot, base_troop, slot_troop_sod_upgrades, 1))


def make_experienced(troops, troop, upgrade):
	exp_troop = troops[troop][:]
	exp_troop[8] = troops[upgrade][8]
	exp_troop[9] = troops[upgrade][9]
	exp_troop[10] = troops[upgrade][10]
	exp_troop[0] += "1"
	exp_troop[1] += "*"
	exp_troop[2] += "*"
	troops.append(exp_troop)
	return len(troops)-1
...
def upgrade(troops,troop1_id,troop2_id):
  ...
  if (troop1_no == -1):
    ...
    exp_troop = make_experienced(troops, troop1_no, troop2_no)
    sod_upgrade(troops, exp_troop, troop2_no)
    cur_troop = troops[troop1_no]
    cur_troop_length = len(cur_troop)
    if cur_troop_length == 11:
      cur_troop[11:11] = [0, 0, exp_troop, 0]
    elif cur_troop_length == 12:
      cur_troop[12:12] = [0, exp_troop, 0]
    else:
      cur_troop[13:cur_troop_length] = [exp_troop, 0]
...
def upgrade2(troops,troop1_id,troop2_id,troop3_id):
  ...
  if (troop1_no == -1):
    ...
    exp_troop = make_experienced(troops, troop1_no, troop2_no)
    sod_upgrade2(troops, exp_troop, troop2_no, troop3_no)
    cur_troop = troops[troop1_no]
    cur_troop_length = len(cur_troop)
    if cur_troop_length == 11:
      cur_troop[11:11] = [0, 0, exp_troop, 0]
