...
skills = [
  ...
  #SoD begin
  #MORDACHAI - updated leadership effects
  ("leadership","Leadership",sf_base_att_cha,10,"Every point increases maximum number of troops you can command by 10, increases your party morale 10, reduces troop wages by 5%% and increases maximum number of prisoners. (Leader skill)"),
  ("prisoner_management", "Administration",sf_base_att_int,10,"Mastering gouverning skills allows you to efficiently maintain large domain. Ech level of this skill increases your demesne points by 50 while each fief you have decreases this number: Village 10, Castle 15, Town 30. Each demesne point can increase or decrease your income by 1%%. (Ruler Skill)"),
  #SoD end
  ...
  #SoD begin
  ("persuasion","Intrigues", sf_base_att_int,10, "This skill helps you make other people accept your point of view. It also increases your propaganda points by 50 while each fief reduces this number: Village 10, Castle 15, Town 30. Negative propaganda values will decrease your relations with fiefs. (Personal/Ruler skill)"),
  #SoD end
