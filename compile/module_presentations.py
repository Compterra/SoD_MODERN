...
# [ src/presentations/0012_sliders/sliders.py:L1-L157 ] sliders
("sliders",0,0,[
      (ti_on_presentation_load,
       [(set_fixed_point_multiplier, 1000),
...
# [ src/presentations/0015_jq_companions_quickview/jq_companions_quickview.py:L1-L896 ] jq_companions_quickview
...
# [ src/presentations/0016_strategic_map/strategic_map.py:L1-L467 ] strategic_map
("strategic_map", 0, 0,
    [
      (ti_on_presentation_load,
        [
...
# [ src/presentations/0020_sod_fief_management/sod_fief_management.py:L1-L1371 ] sod_fief_management
...
# [ src/presentations/0021_sod_royal_artifacts/sod_royal_artifacts.py:L1-L976 ] sod_royal_artifacts
...
# ###############################################################################################
	...
	(else_try),
		...
		(party_remove_members , "p_main_party", "$sod_royal_hero", reg13),
		(assign, "$sod_royal_heroes", reg13),
		(assign, reg12, 0),
		(assign, reg13, 0),
	...
	(else_try),
		...
		(try_begin),
			...
			(str_store_string, s36, "@^We know that one of the artifacts is here."),
		(try_end),	
		(str_store_string, s35, "@Zerrikaresh. Zerrikanian Capital. Jawel of the desert.{s36}"),
		(start_presentation, "prsnt_sod_royal_artifacts"),
	(else_try),
		(eq, ":object", "$g_presentation_obj_9"),
...
# [ src/presentations/0022_sod_description/sod_description.py:L1-L113 ] sod_description
("sod_description", 0, 0,[
