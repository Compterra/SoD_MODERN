...
# [ src/presentations/0020_sod_fief_management/sod_fief_management.py:L1-L1432 ] sod_fief_management
...
#############################################################
		...
		(eq, "$pres_sod_fief_info", 1),		
			  ...
			  (call_script, "script_sod_get_center_construction_cost", "$pres_sod_fief_selected", "$pres_sod_fief_selected_building", ":improvement_cost"),
			  (assign, ":improvement_cost", reg0),
			  (assign, reg13, reg1),
			  (assign, reg5, ":improvement_cost"),
			  (call_script, "script_sod_get_building_development_required", "$pres_sod_fief_selected_building"),
			  (assign, reg10, reg0),
			  (call_script, "script_sod_get_center_construction_workforce", "$pres_sod_fief_selected"),
			  (assign, reg11, reg0),
			  (assign, reg12, 0),
			  (try_begin),
			    (gt, reg11, 0),
			    (store_add, ":weeks_minus_one", reg10, reg11),
...
# #############################################################################################
	...
	(else_try),
		...
		(is_between, "$pres_sod_fief_selected", centers_begin, centers_end),
		(gt, "$pres_sod_fief_selected_building", 0),
		(party_slot_eq, "$pres_sod_fief_selected", slot_center_current_improvement, 0),
		(party_slot_eq, "$pres_sod_fief_selected", "$pres_sod_fief_selected_building", 0),
		(call_script, "script_validate_construction_choice", "$pres_sod_fief_selected", "$pres_sod_fief_selected_building"),
		(eq, reg0, 1),
		(call_script, "script_get_improvement_details", "$pres_sod_fief_selected_building"),
		...
		(call_script, "script_sod_get_center_construction_cost", "$pres_sod_fief_selected", "$pres_sod_fief_selected_building", ":construction_cost"),
		(assign, ":construction_cost", reg0),
