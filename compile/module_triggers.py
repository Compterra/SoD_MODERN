...
#Kingdom Parties
  (1.0, 0, 0.0, [],
   [(try_for_range, ":cur_kingdom", kingdoms_begin, kingdoms_end),
      ...
      #MORDACHAI - allow player's kingdom to have caravans too
...
# Runaway Peasants quest
  (0.2, 0.0, 0.0,
   ...
   # Runaway slaves quest
  (0.2, 0.0, 0.0,
   [
       (check_quest_active, "qst_slavers_bring_back_runaway_slaves"),
       (neg|check_quest_concluded, "qst_slavers_bring_back_runaway_slaves"),
       (quest_get_slot, ":quest_target_center", "qst_slavers_bring_back_runaway_slaves", slot_quest_target_center),
	   
	   (try_begin),
		 (party_is_active, "$qst_bring_back_runaway_slaves_party_1"),
		 (try_begin),
			(party_is_in_town, "$qst_bring_back_runaway_slaves_party_1", ":quest_target_center"),
			(remove_party, "$qst_bring_back_runaway_slaves_party_1"),
			(val_add, "$qst_bring_back_runaway_slaves_num_parties_returned", 1),
		 (try_end),
	   (else_try),
		 (party_slot_eq, "$qst_bring_back_runaway_slaves_party_1", slot_party_slaves_fleed, 1),
       ...
       (try_begin),
		 ...
		 (try_begin),
           (party_is_in_town, "$qst_bring_back_runaway_slaves_party_2", ":quest_target_center"),
           (remove_party, "$qst_bring_back_runaway_slaves_party_2"),
           (val_add, "$qst_bring_back_runaway_slaves_num_parties_returned", 1),
		 (try_end),
	   (else_try),
		(party_slot_eq, "$qst_bring_back_runaway_slaves_party_2", slot_party_slaves_fleed, 1),
		(val_add, "$qst_bring_back_runaway_slaves_num_parties_fleed", 1),
       (try_end),
       ...
       (try_begin),
		 ...
		 (try_begin),
           (party_is_in_town, "$qst_bring_back_runaway_slaves_party_3", ":quest_target_center"),
           (remove_party, "$qst_bring_back_runaway_slaves_party_3"),
           (val_add, "$qst_bring_back_runaway_slaves_num_parties_returned", 1),
		 (try_end),
	   (else_try),
		(party_slot_eq, "$qst_bring_back_runaway_slaves_party_3", slot_party_slaves_fleed, 1),
		(val_add, "$qst_bring_back_runaway_slaves_num_parties_fleed", 1),
       (try_end),
	   
	   (assign, ":sum_removed", "$qst_bring_back_runaway_slaves_num_parties_returned"),
       (val_add, ":sum_removed", "$qst_bring_back_runaway_slaves_num_parties_fleed"),
       (ge, ":sum_removed", 3),
       (try_begin),
         (ge, "$qst_bring_back_runaway_slaves_num_parties_returned", 3),
         (call_script, "script_succeed_quest", "qst_slavers_bring_back_runaway_slaves"),
       (else_try),
         (eq, "$qst_bring_back_runaway_slaves_num_parties_returned", 0),
         (call_script, "script_fail_quest", "qst_slavers_bring_back_runaway_slaves"),
       (else_try),
         (call_script, "script_conclude_quest", "qst_slavers_bring_back_runaway_slaves"),
       (try_end),
    ],
   []
   ),
...
# Follow Spy quest
  (0.5, 0.0, 0.0,
   [
       ...
       (is_between, ":quest_giver_center", centers_begin, centers_end),
       (is_between, ":quest_object_center", centers_begin, centers_end),
       (assign, ":spy_active", 0),
       (try_begin),
       ...
       (else_try),
         ...
         (try_begin),
           ...
           (display_message, "str_qst_follow_spy_noticed_you", quest_fail_color),
         (else_try),
...
# Slavers Escort merchant caravan:
  (0.1, 0.0, 0.1, [(check_quest_active, "qst_slavers_escort_merchant_caravan"),
                   (eq, "$slavers_escort_merchant_caravan_mode", 1)
                   ],
  ...
  (0.1, 0.0, 0.1, [(check_quest_active, "qst_slavers_escort_merchant_caravan"),
                    (eq, "$slavers_escort_merchant_caravan_mode", 0),
                    ],
                   [(quest_get_slot, ":quest_target_party", "qst_slavers_escort_merchant_caravan", slot_quest_target_party),
                    (try_begin),
                      (party_is_active, ":quest_target_party"),
  ...
  (0.1, 0, 0.0, [(check_quest_active, "qst_slavers_escort_merchant_caravan"),
                 (quest_get_slot, ":quest_target_party", "qst_slavers_escort_merchant_caravan", slot_quest_target_party),
                 (neg|party_is_active, ":quest_target_party"),
                 ],
                [(call_script, "script_abort_quest", "qst_slavers_escort_merchant_caravan", 2),
                 ]),
# Black army Escort merchant caravan:
  (0.1, 0.0, 0.1, [(check_quest_active, "qst_black_army_escort_merchant_caravan"),
                   (eq, "$black_army_escort_merchant_caravan_mode", 1)
                   ],
  ...
  (0.1, 0.0, 0.1, [(check_quest_active, "qst_black_army_escort_merchant_caravan"),
                    (eq, "$black_army_escort_merchant_caravan_mode", 0),
                    ],
                   [(quest_get_slot, ":quest_target_party", "qst_black_army_escort_merchant_caravan", slot_quest_target_party),
                    (try_begin),
                      (party_is_active, ":quest_target_party"),
  ...
  (0.1, 0, 0.0, [(check_quest_active, "qst_black_army_escort_merchant_caravan"),
                 (quest_get_slot, ":quest_target_party", "qst_black_army_escort_merchant_caravan", slot_quest_target_party),
                 (neg|party_is_active, ":quest_target_party"),
                 ],
                [(call_script, "script_abort_quest", "qst_black_army_escort_merchant_caravan", 2),
                 ]),
# Troublesome bandits
  (0.3, 0.0, 1.1, [(check_quest_active, "qst_troublesome_bandits"),
                  ...
                  [(display_message, "str_bandits_eliminated_by_another", quest_fail_color),
...
# elephant_guard Ravaging bandits
  (0.3, 0.0, 1.1, [(check_quest_active, "qst_elephant_guard_troublesome_bandits"),
                   (neg|check_quest_succeeded, "qst_elephant_guard_troublesome_bandits"),
                   (quest_get_slot, ":previous_eliminated_by_player", "qst_elephant_guard_troublesome_bandits", slot_quest_bandits_eliminated_by_player),
                   (store_num_parties_destroyed_by_player, ":cur_eliminated_by_player", "pt_elephant_guard_ravaging_bandits"),
                   (neq, ":cur_eliminated_by_player", ":previous_eliminated_by_player"),
                   ],
                  [(call_script, "script_succeed_quest", "qst_elephant_guard_troublesome_bandits"), ]),
# conquistadors Ravaging bandits
  (0.3, 0.0, 1.1, [(check_quest_active, "qst_conquistadors_troublesome_bandits"),
                   (neg|check_quest_succeeded, "qst_conquistadors_troublesome_bandits"),
                   (quest_get_slot, ":previous_eliminated_by_player", "qst_conquistadors_troublesome_bandits", slot_quest_bandits_eliminated_by_player),
                   (store_num_parties_destroyed_by_player, ":cur_eliminated_by_player", "pt_conquistadors_ravaging_bandits"),
                   (neq, ":cur_eliminated_by_player", ":previous_eliminated_by_player"),
                   ],
                  [(call_script, "script_succeed_quest", "qst_conquistadors_troublesome_bandits"), ]),
# serpent_host Ravaging bandits
  (0.3, 0.0, 1.1, [(check_quest_active, "qst_serpent_host_troublesome_bandits"),
                   (neg|check_quest_succeeded, "qst_serpent_host_troublesome_bandits"),
                   (quest_get_slot, ":previous_eliminated_by_player", "qst_serpent_host_troublesome_bandits", slot_quest_bandits_eliminated_by_player),
                   (store_num_parties_destroyed_by_player, ":cur_eliminated_by_player", "pt_serpent_host_ravaging_bandits"),
                   (neq, ":cur_eliminated_by_player", ":previous_eliminated_by_player"),
                   ],
                  [(call_script, "script_succeed_quest", "qst_serpent_host_troublesome_bandits"), ]),
# bc bandits
  (0.3, 0.0, 1.1, [(check_quest_active, "qst_bc_troublesome_bandits"),
                   (neg|check_quest_succeeded, "qst_bc_troublesome_bandits"),
                   (quest_get_slot, ":previous_eliminated_by_player", "qst_bc_troublesome_bandits", slot_quest_bandits_eliminated_by_player),
                   (store_num_parties_destroyed_by_player, ":cur_eliminated_by_player", "pt_bc_bandits"),
                   (neq, ":cur_eliminated_by_player", ":previous_eliminated_by_player"),
                   ],
                  [(call_script, "script_succeed_quest", "qst_bc_troublesome_bandits"), ]),
# slavers smuggle_wine
  (0.3, 0.0, 0.0, [(check_quest_active, "qst_slavers_deliver_wine"),
                   (neg|check_quest_succeeded, "qst_slavers_deliver_wine"),
                   (quest_get_slot, ":target_center", "qst_slavers_deliver_wine", slot_quest_target_center),
                   (store_distance_to_party_from_party, ":dist", ":target_center", "p_main_party"),
                   (lt, ":dist", 3),
                   ],
                  [(start_map_conversation, "trp_wine_recipient"),]),
# jotnar_clan_escort
  (0.3, 0.0, 0.0, [(check_quest_active, "qst_jotnar_clan_escort"),
                   (neg|check_quest_succeeded, "qst_jotnar_clan_escort"),
                   (main_party_has_troop, jotnar_clan_noble),
				   (quest_get_slot, ":target_center", "qst_jotnar_clan_escort", slot_quest_target_center),
                   (store_distance_to_party_from_party, ":dist", ":target_center", "p_main_party"),
                   (lt, ":dist", 3),
                   ],
                  [(start_map_conversation, jotnar_clan_noble),]),
  (0.3, 0.0, 0.3, [(check_quest_active, "qst_jotnar_clan_escort"),
                   (neg|check_quest_succeeded, "qst_jotnar_clan_escort"),
                   (neg|check_quest_failed, "qst_jotnar_clan_escort"),
                   (neg|main_party_has_troop, jotnar_clan_noble),
                   ],
...
# serpent host free spy:
   ...
   [(check_quest_active, "qst_serpent_host_free_spy"),
	...
	(else_try),
		...
		(party_get_num_prisoners, ":prisoners", ":quest_target_party"),
		(gt, ":prisoners", 0),
		(remove_party, "$g_sh_spy"),
		(quest_set_slot, "qst_serpent_host_free_spy", slot_quest_current_state, 2),
   ...
   [
        (try_for_range, ":pretender", pretenders_begin, pretenders_end),
          ...
          (try_for_range, ":unused", 0, 30),
            ...
            (try_begin),
              (eq, "$cheat_mode", 1),
              (call_script, "script_store_troop_name", 4, ":pretender"),
...
#Set their relation to the player
        ...
        (val_max, ":grievance_divisor", 1),
        (assign, reg7, ":grievance_divisor"),

#        (display_message, "@Process NPC changes. GD: {reg7}", debug_color),
...
###Check for coming out of retirement
            ...
            (try_begin),
                ...
                (call_script, "script_store_troop_name", s31, ":npc"),
                (troop_get_slot, ":player_renown", "trp_player", slot_troop_renown),
                (assign, reg4, ":player_renown"),
                (assign, reg5, ":renown_min"),
#                (display_message, "@Test {s31}  for retirement return {reg4}, {reg5}.", debug_color),
...
# Fix file format:             #twan453 : this script was here to maintain save compatibility between two versions 4.1, it may create problem if version is called 453
   (0.1, 0, ti_once, [(lt, "$g_sod_file_version", current_file_version)], [
   ]),
